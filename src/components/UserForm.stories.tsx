...
export const InputAll: Story = {
  play: async (ctx) => {
    ...
    await expect(listItems[0]).toHaveTextContent("Name: example-name");
    await expect(listItems[1]).toHaveTextContent("Age: 20");
    await expect(listItems[2]).toHaveTextContent("Email: example-email");
  },
};
